...
format:
  revealjs:
    theme: simple
    slide-number: true
    footer: "Seminario científico de BIOMED · [English version](en.html)"
    transition: fade
...
## Plataformas: describís la app y aparece (hasta se publica!) {.smaller}
...
— Niklas Gruhn, «[Don't be a meat proxy](https://gruhn.me/blog/2026-08-03/)», 3 de agosto de 2026 (traducción propia)
:::
