...
-   Prototipos en dias u horas
-   Iteraciones más rápidas
-   Menos (o nada de) intermediarios

## Entre prototipo y producción

Algunas preguntas que suelen presentarse luego:

::: incremental
-   ¿Cómo integro esto en la plataforma de mi institución?
-   ¿Cómo integro el sistema (UI y BBDD) generado con herramientas específicas (medios de pago, calendarización, otras plataformas)?
-   ¿Cómo lo pago cuando supero los niveles del plan gratuito?
-   ¿Cómo sé que los datos que ingresan mis usuarios (o los que yo ingresé) están seguros?
-   ¿Qué tan difícil es levantar esto de 0 en mi organización?
:::
...
-   **11 de marzo**: Samsung levanta la prohibición de usar ChatGPT que regía para sus empleados
-   **Filtraciones**: un ingeniero pega el código fuente completo de un programa de su base de datos de semiconductores para pedir una corrección; otro hace lo mismo con el código de un equipo defectuoso; un tercero sube una reunión entera para que le arme las minutas
-   **Medida de emergencia**: limitación de largo de prompts
-   **Principios de mayo**: vuelve la prohibición, ahora para toda herramienta de IA generativa. El motivo, según el memo interno: lo que se transmite queda en servidores externos, es difícil de recuperar o borrar y podría terminar expuesto a otros usuarios
...
## No todo necesita convertirse en software institucional

Pero si tu objetivo es una herramienta de impacto real, es importante tener en cuenta
